            ...
            <div class="row">
                        ...
                        <div class="team-info-widget mt-4">
                            ...
                            @if($doctor->social_links)
                                <ul class="social-profile list-style mt-4">
                                    @if(isset($doctor->social_links['facebook']))
                                        <li><a href="{{ $doctor->social_links['facebook'] }}" target="_blank"><i
                                                    class="ri-facebook-fill"></i></a></li>
                                    @endif
                                    @if(isset($doctor->social_links['twitter']))
                                        <li><a href="{{ $doctor->social_links['twitter'] }}" target="_blank"><i
                                                    class="ri-twitter-fill"></i></a></li>
                                    @endif
                                    @if(isset($doctor->social_links['linkedin']))
                                        <li><a href="{{ $doctor->social_links['linkedin'] }}" target="_blank"><i
                                                    class="ri-linkedin-fill"></i></a></li>
                                    @endif
                                    @if(isset($doctor->social_links['instagram']))
                                        <li><a href="{{ $doctor->social_links['instagram'] }}" target="_blank"><i
                            ...
                            <div class="mt-4">
                                <a href="{{ route('appointments.create') }}"
                                    class="btn style-one w-100">{{ __('general.book_appointment') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="team-details-content">
                        ...
                        @else
                            <p>{{ $doctor->name }} is a highly qualified {{ $doctor->specialization }} with
                                {{ $doctor->experience_years }}+ years of experience in dental care.
                            </p>
                        @endif
                        <!-- 
